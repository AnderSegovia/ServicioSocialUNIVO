...
<input type="hidden" name="_csrf" value="<?= Yii::$app->request->getCsrfToken() ?>" />
      ...
      <div class="inputGroup inputGroup1">
        <label for="loginEmail" id="loginEmailLabel" required>Email</label>
        <input type="email" id="loginEmail" name="LoginForm[email]" maxlength="254" />
      </div>

    <div class="inputGroup inputGroup2">
        <label for="loginPassword" id="loginPasswordLabel" required minlength="6">Password</label>
        <input type="password" id="loginPassword" name="LoginForm[password]" />
